...
class Ui_mapbioImporter(object):
    def setupUi(self, mapbioImporter):
        ...
        self.formLayout.setWidget(9, QtGui.QFormLayout.LabelRole, self.lblSpatialDataSource)
        ...
        self.cbSpatialDataSource.addItem(_fromUtf8(""))
        self.cbSpatialDataSource.addItem(_fromUtf8(""))
        self.formLayout.setWidget(9, QtGui.QFormLayout.FieldRole, self.cbSpatialDataSource)
        self.lblSpatialDataScale = QtGui.QLabel(mapbioImporter)
        self.lblSpatialDataScale.setObjectName(_fromUtf8("lblSpatialDataScale"))
        self.formLayout.setWidget(10, QtGui.QFormLayout.LabelRole, self.lblSpatialDataScale)
        ...
        self.formLayout.setWidget(10, QtGui.QFormLayout.FieldRole, self.spbxSpatialDataScale)
        self.lblContentCodes = QtGui.QLabel(mapbioImporter)
        self.lblContentCodes.setObjectName(_fromUtf8("lblContentCodes"))
        self.formLayout.setWidget(4, QtGui.QFormLayout.LabelRole, self.lblContentCodes)
        self.cbContentCodes = QtGui.QComboBox(mapbioImporter)
        self.cbContentCodes.setObjectName(_fromUtf8("cbContentCodes"))
        self.formLayout.setWidget(4, QtGui.QFormLayout.FieldRole, self.cbContentCodes)
        ...
        self.formLayout.setWidget(6, QtGui.QFormLayout.LabelRole, self.lblRecordingDate)
        self.cbRecordingDate = QtGui.QComboBox(mapbioImporter)
        self.cbRecordingDate.setObjectName(_fromUtf8("cbRecordingDate"))
        self.formLayout.setWidget(6, QtGui.QFormLayout.FieldRole, self.cbRecordingDate)
